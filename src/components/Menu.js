...
const Menu = () => {
  ...
  return (
    ...
    <>
      <nav
        className={
          "trans d-flex justify-content-around  align-items-center navbar navbar-expand-md navbar-light header-scroll header-sm-scroll"
        }
      >
       <div className="">
        <div className="d-flex align-items-center">
          <img src="/images/templogo.jpeg" width="40" height={40} />
          <div className="d-flex flex-column justify-content-center">
            <div style={{ fontSize: 13, fontWeight: "bold", marginButtom: 0 }}>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
              ...
              <NavLink
                  to="#footer"
                  className={(nav) =>
                    nav.isActive ? "nav-link nav-trans mx-4 " : "mx-4 nav-link nav-trans"
                  }
                >
                 تماس با ما
                </NavLink>
