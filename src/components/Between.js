...
function Between(props) {
    return (
        <div className=" row betcontainer px-md-4  justify-content-around align-items-center">
            <div className='col-md-3 d-flex  ms-md-0 justify-content-md-center align-items-center'>
            <div className='icon '>
